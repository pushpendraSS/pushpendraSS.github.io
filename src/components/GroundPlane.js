...
import { Decal, OrbitControls, SpotLight, Stars } from '@react-three/drei';
...
import LightBamboo from './LightBamboo';
    ...
    return (
        <Canvas>
            ...
            {/* <spotLight
                ...
                shadow-mapSize={1024}
            /> */}
            <LightBamboo position={[-49, 0, -49]} poleHeight={25} poleRadius={0.2} lampRadius={0.5}></LightBamboo>
            ...
            <Avatar url="./avatar.glb" scale={[7, 7, 7]} position={[0, 0.9, 0]} />
